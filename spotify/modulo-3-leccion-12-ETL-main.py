...
bss.creacion_bbdd_tablas(query.query_creacion_bbdd, "admin", "spotify_i")
...
datos_tabla_caracteristicas = bss.convertir_float(datos_tabla_caracteristicas)
...
bss.insertar_datos(query.query_insertar_canciones, "admin", "spotify_i", datos_tabla_canciones)

# INSERTAR EN ARTISTAS
bss.insertar_datos(query.query_insertar_artistas, "admin", "spotify_i", datos_tabla_artistas)

# INSERTAR EN CANCIONES ARTISTAS
bss.insertar_datos(query.query_insertar_canciones_artistas, "admin", "spotify_i", datos_tabla_canciones_artistas)

# INSERTAR CARACTERISTICAS
bss.insertar_datos(query.query_insertar_caracteristicas, "admin", "spotify_i", datos_tabla_caracteristicas)
